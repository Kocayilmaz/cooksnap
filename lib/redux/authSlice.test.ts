...
describe("authSlice", () => {
  it("varsayilan durumda status loading, uid/email null gelir", () => {
  ...
  it("setUnauthenticated uid/email'i temizleyip status'u unauthenticated yapar", () => {
    const authenticated = reducer(undefined, setAuthenticatedUser({ uid: "abc123", email: "test@example.com" }));
