...
const HERO_IMAGES = [
  ...
  },
  {
    ...
    width: 600,
    height: 600,
    className: "hidden lg:block lg:w-10 lg:top-2 lg:left-52 animate-float",
  },
  {
    src: "/yaprak-2.png",
    alt: "Yaprak",
    width: 500,
    height: 877,
    className: "hidden lg:block lg:w-10 lg:bottom-24 lg:left-16 animate-float-delayed",
  },
  {
    src: "/yaprak-3.png",
    alt: "Yaprak",
  ...
  },
  {
    ...
    width: 2362,
    height: 2362,
    className: "hidden lg:block lg:w-12 lg:bottom-8 lg:left-80 animate-float-delayed",
  },
  {
    src: "/nane.png",
    alt: "Nane",
    width: 1183,
    height: 1063,
    className: "hidden lg:block lg:w-10 lg:bottom-24 lg:left-88 animate-float",
  },
  {
    src: "/cilek.png",
    alt: "Çilek",
    width: 1600,
    height: 1548,
    className: "hidden lg:block lg:w-12 lg:bottom-8 lg:right-72 animate-float-delayed",
  },
  {
  ...
  },
  {
    ...
    width: 2362,
    height: 2362,
    className: "hidden lg:block lg:w-8 lg:top-4 lg:right-96 animate-float",
  },
  {
    src: "/nane.png",
    alt: "Nane",
    width: 1183,
    height: 1063,
    className: "hidden lg:block lg:w-8 lg:bottom-4 lg:right-96 animate-float-delayed",
  },
];
